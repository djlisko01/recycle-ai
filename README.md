...
![Website Screenshot](https://github.com/greeny90/recycle-ai/blob/main/tweet.png =250x250)
- ThingSpeak's TalkBack feature changes the LED light on the Arduino board based on the image identified. 
     ...
     - Red = Trash
![Website Screenshot](https://github.com/greeny90/recycle-ai/blob/main/arduino.png =250x250)
